...
use spmv::utils;
use spmv::sparse::SingleThreadOptimized as SpmvMatrix;
use spmv::SpMV;
...
criterion_group!(sparsity, size_100, size_1000, size_10000,size_20000, sparsity_10_percent, sparsity_20_percent, sparsity_30_percent);
